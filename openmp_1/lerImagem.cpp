...
int showImage(char arq[])
{
	...
	double start = omp_get_wtime();
		...
		#pragma omp parallel num_threads(4) default(none) shared(rows_rest ,imagem, cropped, cropped_image1, cropped_image2, cropped_image3, cropped_image4, erode_output1, erode_output2, erode_output3, erode_output4, dilate_output1, dilate_output2, dilate_output3, dilate_output4)
		{
